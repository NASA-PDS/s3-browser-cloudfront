...
export function sortables_init() {
...
window.ts_makeSortable = function ts_makeSortable(t) {
...
window.ts_getInnerText = function ts_getInnerText(el) {
...
window.ts_resortTable = function ts_resortTable(lnk, clid) {
	var span;
	...
	if (itm == "") return; 
        ...
        //alert(itm);
	var sortfn = ts_sort_caseinsensitive; //defaults to i-case Alphabetical Order
...
window.ts_sort_date = function ts_sort_date(a,b) {
...
window.ts_sort_numeric = function ts_sort_numeric(a,b) {
...
window.ts_sort_caseinsensitive = function ts_sort_caseinsensitive(a,b) {
	var aa = ts_getInnerText(a.cells[SORT_COLUMN_INDEX]);
    if (aa === undefined)
        return 0;
...
window.ts_sort_default = function ts_sort_default(a,b) {
	var aa = ts_getInnerText(a.cells[SORT_COLUMN_INDEX]);
	var bb = ts_getInnerText(b.cells[SORT_COLUMN_INDEX]);
	if (aa==bb) {
		return 0;
